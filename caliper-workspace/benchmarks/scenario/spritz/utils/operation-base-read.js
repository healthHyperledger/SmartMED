...
class OperationBase extends WorkloadModuleBase {
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        this.assertSetting('dataOwner');
        this.assertSetting('levelRequested');
        //this.assertSetting('numberOfAccounts');

        this.dataOwner = this.roundArguments.dataOwner; //creates field in the object
        this.levelRequested = this.roundArguments.levelRequested;
