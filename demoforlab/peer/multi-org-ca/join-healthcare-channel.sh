...
# peer channel fetch config $AIRLINE_CHANNEL_BLOCK -o $ORDERER_ADDRESS -c healthcarechannel
peer channel fetch 0 $AIRLINE_CHANNEL_BLOCK -o $ORDERER_ADDRESS -c healthcarechannel
