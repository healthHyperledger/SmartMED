...
configtxgen -profile TestOrdererGenesis -outputBlock ./acme-genesis.block -channelID ordererchannel

#5. Create the acmechannel transaction
echo    '================ Writing channel transaction ================'
configtxgen -profile TestChannel -outputCreateChannelTx ./acme-channel.tx -channelID healthcarechannel
